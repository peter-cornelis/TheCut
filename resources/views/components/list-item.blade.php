...
<li class="relative grid grid-cols-[4.2rem_auto_1fr_auto] bg-card rounded-md shadow-md shadow-black/50 border-2 border-border hover:border-foreground/30 transition-colors duration-300">
    ...
    <menu  class="grid grid-cols-2 bg-border rounded-r z-10">
        <button class="flex items-center justify-center col-start-2 hover:bg-indigo-400 rounded-tr transition-colors duration-300">
            <x-svg.up class='w-6 h-6' />
        </button>
        <button class="flex items-center justify-center col-start-2 hover:bg-indigo-400 rounded-br border-t border-background transition-colors duration-300">
